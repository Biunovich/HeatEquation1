...
//	return E;
//}
//double** matrmatr(double **A, double **B, int n)
//{
...
//	//teplo->write();
//	//teplo->printtridiag();
//	double ** tridiaginvers;
//	tridiaginvers = inversion(teplo->tridiag, teplo->kt - 1);
//	//teplo->printtridiag();
...
//	}
//	printf("\n");
//	double **x = matrmatr(tridiaginvers, teplo->tridiag, teplo->kt-1);
//	write(x, teplo->kt-1);
//	delete teplo;
//}